...
<section>
    <div>
        <h1 class=\"text-center bg-info\">Politique de confidentialité</h1>
    </div>
    <div>
        <h1 class=\"text-center bg-info\">Champs d'application</h1>
    ...
    <div>
        <h1 class=\"text-center bg-info\">A propos de TROC'ECO</h1>
    ...
    <div>
        <h1 class=\"text-center bg-info\">Traitement des données à caractère personnel</h1>
