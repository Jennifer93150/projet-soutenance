...
class __TwigTemplate_77b28e53ee747a5f89dad051a6f076d235badc1b8ec3a711183d7a1cc75244ae extends \Twig\Template
{
    ...
    public function block_contenuPrincipal($context, array $blocks = [])
    {
        ...
        echo "
<div>
    <h1 class=\"text-center\">Catégorie Vêtement</h1>
</div>
<div>
    <ul>
    ";
...
<div>
    ...
    {% for produit in produits %}
        <div class=\"card mb-3 card-size\" style=\"max-width: 1120px;\">
            <div class=\"row g-0\">
                <div class=\"col-md-4 image\">
                <img src=\"{{ asset('img/' ~ produit.photo) }}\" class=\"img-thumbnail\" alt=\"\"/>
                </div>
                <div class=\"col-md-8\">
                    <div class=\"card-body background-maison\">
                    <!-- synthaxe: produit.titre (produit= nom1ereVarDuFor . titre= nomDonnéSurFormulaireAdd) -->
...
{% endblock %}", "troc-eco/categories/vetement.html.twig", "/Applications/MAMP/htdocs/SYMFONY/projet-soutenance/templates/troc-eco/categories/vetement.html.twig");
    }
}
